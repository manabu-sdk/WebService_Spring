Insert into MENU (MENU_ID,MENU_NAME,ACTION,POSITION,ICON_TYPE,IS_AVAILABLE) values ('MST_USER','ユーザーメンテナンス画面','/user',1,'04','1');
...
Insert into MENU (MENU_ID,MENU_NAME,ACTION,POSITION,ICON_TYPE,IS_AVAILABLE) values ('MST_LOGOUT','ログアウト','/logout',99,'04','1');
